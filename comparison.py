...
# Parameters
MODE = "ECB"
message_lengths = [256, 512, 1024,2048,5000,7500,10000,20000,50000,750000,1000000,2000000]  # in characters
rsa_times = []
rsa_key_times = []
aes_times = []
aes_key_times = []
...
for length in message_lengths:
    ...
    rsa_key_times.append(round(rsa_key_time/5,6))
    rsa_times.append(round(rsa_final_time/5,6))
    aes_key_times.append(round(aes_key_time/5,6))
    aes_times.append(round(aes_final_time/5,6))
...
plt.plot(message_lengths, rsa_key_times, marker='s', label='RSA Key Generation')
...
plt.plot(message_lengths, aes_key_times, marker='s', label='AES Key Generation')
